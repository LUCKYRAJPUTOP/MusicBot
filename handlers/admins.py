...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("**RAJPUTBOT:** ⏸ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("**RAJPUTBOT:** ▶️ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("**RAJPUTBOT:** ⏹ Stopped.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("**RAJPUTBOT:** ❇️ Admin cache refreshed!")
